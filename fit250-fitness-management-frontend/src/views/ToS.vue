          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to FIT250.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to FIT250, accessible from
                <a
                  href="https://www.fit250.com"
                  rel="external nofollow noopener"
                  target="_blank"
                  >https://www.fit250.com</a
                >
              </p>
            </li>
            <li>
...
export default {
  ...
  props: {
    header: {
      type: String,
      default: require("@/assets/img/bg/bg_tos.jpg")
    }
  },
  data() {
    return {};
